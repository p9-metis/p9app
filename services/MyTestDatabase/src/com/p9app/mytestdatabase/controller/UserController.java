...
import com.p9app.mytestdatabase.service.UserService;
...
import com.p9app.mytestdatabase.service.*;


/**
 * Controller object for domain model class User.
 * @see com.p9app.mytestdatabase.User
 */

@RestController(value = "MyTestDatabase.UserController")
@Api(value = "/MyTestDatabase/User", description = "Exposes APIs to work with User resource.")
@RequestMapping("/MyTestDatabase/User")
public class UserController {

    private static final Logger LOGGER = LoggerFactory.getLogger(UserController.class);

	@Autowired
	@Qualifier("MyTestDatabase.UserService")
